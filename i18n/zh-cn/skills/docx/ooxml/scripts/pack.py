#!/usr/bin/env python3
"""
将目录打包为 .docx、.pptx 或 .xlsx 文件的工具，同时取消 XML 格式化。
...
def main():
    ...
    parser.add_argument("input_directory", help="解包的 Office 文档目录")
...
def pack_document(input_dir, output_file, validate=False):
    ...
    参数：
        input_dir: 解包的 Office 文档目录路径
        output_file: 输出 Office 文件路径
        validate: 如果为 True，则使用 soffice 进行验证（默认：False）
